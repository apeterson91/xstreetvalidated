...
[previous post](https://github.com/apeterson91/xstreetvalidated/tree/main/_posts/2021-08-26-spatial-models) 
on spatial models.
</aside>
...
from a poisson distribution. City events will typically by zero-inflated, as 
incidents such as shootings, car accidents, etc. do not --- typically --- occur 
...
generated. Let $Y_{itm}$ be the number of shootings observed at street $i$, 
...
lack of shootings. For the sake of brevity, we'll simply conclude with one final 
note, a reminder of what this model is and is **not** saying.
