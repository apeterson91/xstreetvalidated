...
As with all human endeavors, nothing is perfect. In this case 
things aren't always simple either. In the posts to come we'll talk 
more about the problems this analysis has, despite the author's best efforts, 
as well as why this result is still so encouraging in spite of those problems. 
One overarching theme to keep in mind, is that this is a fairly 
cheap endeavor, just cleaning up some vacant lots, with a potentially huge 
payoff --- saving human lives! This represents both the simplicity and the 
