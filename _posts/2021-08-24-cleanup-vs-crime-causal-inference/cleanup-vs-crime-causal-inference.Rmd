...
In the paper we've been studying, the author's estimate a decrease 
...
just the greening intervention since that had the more robust results
across the models.
...
different, or worse, the control group had significantly less crime than the 
intervention and they didn't want this result complicating their story. 
...
Thanks to [Kat Hoffman](https://www.khstats.com/) for reading and offering 
