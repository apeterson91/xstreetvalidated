...
by those interested in understanding the built environment. I've written on this 
...
numerous references I suggest 
[here](https://www.apetersonsite.org/post/phdlessons/) to get fully 
up to speed.
...
or exposed are any different from those in the control group, the unexposed. 
...
exposures constantly. Dense, walk-able neighborhoods, tend to be much more 
expensive than their suburban counterparts. Wealth is correlated with 
education, as well as number of other factors and so one might expect a wide 
range of different health outcomes between those in dense walk-able 
neighborhoods, for example, and their more rural counterparts that are not due to 
...
in the built environment. Consider our example with upzoning. Changing the 
...
causal estimate more difficult. Decomposing 
...
to understand the built environment amidst all the many non-randomized, 
correlated and interfering forces at work. 
Fear not, there are still *some* things we can do.
