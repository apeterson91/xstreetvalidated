...
citation_url: https://apeterson91.github.io/xstreetvalidated/
date: 09-11-2021
output:
...
or exposed are any different from those in the control. 
...
```{r wealthvis,fig.width=12,fig.height=8,cache=T,fig.cap="Distribution of Median Income Across Allegheny County, PA Census Tracts."}
...
to estimate the causal estimand^[an estimand is the thing one wishes to estimate.]
...
[@hernan2010causal;@gelman2020regression;@angrist2014mastering;@morgan2015counterfactuals].
